...
myApp.config(['$routeProvider',
  function($routeProvider) {
    $routeProvider.
      when('/activity', {
        templateUrl: '/bundles/woojinstore/template/activity/list.html',
        controller: 'ActlistCtrl'
      }).
      when('/activity/:activityId', {
        templateUrl: '/bundles/woojinstore/template/activity/detail.html',
...
ActivityCtrl.controller('ActDetailCtrl', ['$scope', '$routeParams', 
