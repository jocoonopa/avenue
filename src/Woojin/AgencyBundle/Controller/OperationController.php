...
use Woojin\AgencyBundle\Entity\Operation;
use Woojin\AgencyBundle\Form\OperationType;
...
class OperationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WoojinAgencyBundle:Operation')->findAll();
     ...
     * @Method("POST")
     * @Template("WoojinAgencyBundle:Operation:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WoojinAgencyBundle:Operation')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("WoojinAgencyBundle:Operation:edit.html.twig")
     */
