...
use Woojin\GoodsBundle\Form\BrandType;
...
class BrandController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WoojinGoodsBundle:Brand')->findAll();
     ...
     * @Method("POST")
     * @Template("WoojinGoodsBundle:Brand:new.html.twig")
     */
    ...
    private function createCreateForm(Brand $entity)
    {
        ...
        $form->add('submit', 'submit', array('label' => '新增', 'attr' => $attr));
     ...
     *
     * @Route("/{id}", requirements={"page" = "\d+"}, name="brand_show")
     * @Method("GET")
     * @Template()
     */
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WoojinGoodsBundle:Brand')->find($id);

        if (!$entity) {
            throw $this->createNotFoundException('這個品牌不存在喔!');
        }
     ...
     *
     * @Route("/{id}/edit", requirements={"page" = "\d+"}, name="brand_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
     ...
     *
     * @Route("/{id}", requirements={"page" = "\d+"}, name="brand_update")
     * @Method("PUT")
     * @Template("WoojinGoodsBundle:Brand:edit.html.twig")
     */
     ...
     *
     * @Route("/{id}", requirements={"page" = "\d+"}, name="brand_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ...
            ->setMethod('DELETE')
            ->add('submit', 'submit', array('label' => '刪除', 'attr' => array('class' => 'btn btn-danger')))
            ->getForm()
        ;
    }
}
